...
public interface ModuleService {
    ...
    /**
     * Get vocabulary count for a module
     *
     * @param moduleId Module ID
     * @return Number of vocabularies
     */
    int getVocabularyCount(UUID moduleId);

    /**
     * Get grammar count for a module
     *
     * @param moduleId Module ID
     * @return Number of grammars
     */
    int getGrammarCount(UUID moduleId);
}
